...
2) Navigate to at `Modules`, click `contributed modules` link and Search for Yoti - you can also download the package from [here](https://www.drupal.org/project/yoti).
